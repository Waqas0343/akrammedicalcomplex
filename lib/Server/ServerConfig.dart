...
class ServerConfig {
  ...
  static const login =
      baseUrl + "api/Accounts/LoginPhone_Username?SystemKey=" + systemKey;
  ...
  static const checkUsername =
      baseUrl + "api/Accounts/CheckUserName?SystemKey=" + systemKey;
  static const cities =
      baseUrl + "/api/LabTests/GetLabTests?SystemKey=" + systemKey;
  static const searchTest =
      baseUrl + "/api/LabTests/GetLabTests?SystemKey=" + systemKey;

  static const bookLabTest = baseUrl +
      "api/LabTest/BookMobileLabTest?SystemKey=$systemKey&locationId=${Keys.locationId}";
  ...
  static const medicineOrderPlace = baseUrl +
  ...
  static const doctors = baseUrl +
      "api/doctors/DoctorListShort?SystemKey=$systemKey&Medusername=${Keys.locationId}";

  static const verifyCode =
      baseUrl + "api/Accounts/Activate?SystemKey=$systemKey";

  static const resentCode =
      baseUrl + "api/accounts/getactivationcode?SystemKey=$systemKey";
  static const resendCode = baseUrl +
      "api/OTP/RegenerateOTP?SystemKey=$systemKey&locationID=${Keys.locationId}&projectID=${Keys.projectId}";

  static const prescriptions = baseUrl +
      "api/Prescriptions/MyPrescriptionsList?SystemKey=" +
      systemKey; //username

  static const timeSlots =
      baseEmrUrl + "AppointmentApi/GetTimeByDate?SystemKey=$systemKey";

  static const appointmentSave = baseEmrUrl +
      "AppointmentApi/SaveAppointment?SystemKey=$systemKey&LocationId=${Keys.locationId}&projectID=${Keys.projectId}";

  static const getServices =
      baseEmrUrl + "ServicesApi/GetLocationServices?SystemKey=" + systemKey;

  static const labs =
      baseUrl + "api/LabTest/ListOfLabsShort?SystemKey=" + systemKey;

  static const patientInfoUpdate =
      baseUrl + "api/PatientProfile/BasicInfo_Update?SystemKey=" + systemKey;

  static const labTestBook = baseUrl +
      "api/LabTest/BookMobileLabTest?SystemKey=$systemKey&LocationId=${Keys.locationId}&projectID=${Keys.projectId}";

  static const getPatientInfo =
      baseUrl + "api/PatientProfile/GetList_BasicInfo?SystemKey=" + systemKey;
